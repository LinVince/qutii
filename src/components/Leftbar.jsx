...
useEffect(()=>{
  ...
  return (
    <div className={`leftbar ${drawerStatus ? 'sidebar-shadow' : ''}`}>
      ...
      <Toolbar className={`${drawerStatus === 'overview' ? 'active-leftbar-icon' : ''}`} >
      ...
      <Toolbar className={`${drawerStatus === 'bookmark' ? 'active-leftbar-icon' : ''}`} >
      ...
      <Toolbar className={`${drawerStatus === 'personal' ? 'active-leftbar-icon' : ''}`}  style={{ position: "fixed", left: "0" }}>
